  ...
  const socialLinks = [
    {
      ...
      url: 'https://facebook.com/stylishbubbles',
    },
    {
      name: 'Instagram',
      icon: (
      ...
      url: 'https://instagram.com/stylishbubbles',
    },
    {
      name: 'Pinterest',
      icon: (
      ...
      url: 'https://pinterest.com/stylishbubbles',
    },
    {
      name: 'YouTube',
      icon: (
      ...
      url: 'https://youtube.com/@stylishbubbles',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-4">
          ...
          <Link to="/" className="flex-shrink-0">
            <img 
              src="https://res.cloudinary.com/duc9svg7w/image/upload/v1765275988/file_00000000331472098dd2d6da8b866f40_bh2fch.png" 
              alt="STYLISHBUBBLES Logo" 
              className="h-40 md:h-70 w-auto hover:scale-105 transition-transform duration-300 mb-3"
            />
          </Link>
        ...
        <div className="border-t border-gray-700 pt-3 text-center">
          <p className="text-gray-300 text-xs mb-1">
            © {currentYear} <span className="font-semibold text-white">STYLISHBUBBLES</span>. All rights reserved.
          </p>
